...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    loss = np.sum(np.log(probs[range(N), y])) #data loss
    loss = loss * -(1/N)
    ...
    # since dL/dz = p2 - z2
    # dL/dw2 = dL/dz2 * X^T , dL/db2 = dL/dz2 
    grad_Z2 = probs.reshape(N, -1) # dscores is (N x C)
    ...
    #dL/dz1 = #the ReLU function.
    #dL/dw2 = dL/dz1 * X^T , dL/db1 = dL/dz1 
